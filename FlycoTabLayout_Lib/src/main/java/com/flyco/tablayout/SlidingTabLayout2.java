...
public class SlidingTabLayout2 extends HorizontalScrollView {
    ...
    private ViewPager2PageChangeCallback viewPager2PageChangeCallback = new ViewPager2PageChangeCallback();
    ...
    public void setViewPager(ViewPager2 vp, String[] titles) {
        ...
        this.mViewPager.unregisterOnPageChangeCallback(viewPager2PageChangeCallback);
        this.mViewPager.registerOnPageChangeCallback(viewPager2PageChangeCallback);
    ...
    public void notifyDataSetChanged() {
        ...
        this.mTabCount = mViewPager.getAdapter().getItemCount();
        View tabView;
