...
import com.flyco.tablayout.bens.TabEntity;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener,ViewParent {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorAnimEnable = ta.getBoolean(R.styleable.CommonTabLayout_tl_indicator_anim_enable, false);
        ...
        mTabPaddingLeft=ta.getDimension(R.styleable.CommonTabLayout_tl_tab_padding_left, mTabSpaceEqual || mTabWidth > 0 ? dp2px(0) : dp2px(10));
        mTabPaddingRight=ta.getDimension(R.styleable.CommonTabLayout_tl_tab_padding_right, mTabSpaceEqual || mTabWidth > 0 ? dp2px(0) : dp2px(10));
...
//                    Log.i("ansen","tab选中了");
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            tabView.setPadding((int) mTabPaddingLeft, 0, (int) mTabPaddingRight, 0);
            TextView tv_tab_title = (TextView) tabView.findViewById(R.id.tv_tab_title);
