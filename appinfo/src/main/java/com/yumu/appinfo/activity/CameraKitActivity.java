...
public class CameraKitActivity extends BaseActivity implements Toolbar.OnMenuItemClickListener, EasyPermissions.PermissionCallbacks {
...
//        }
        ...
        cameraView.requestPermissions(CameraKitActivity.this);
...
//    }
    ...
    public boolean onMenuItemClick(MenuItem item) {
        if (item.getItemId() == R.id.main_menu_about) {
            AlertDialog dialog = new AlertDialog.Builder(CameraKitActivity.this).setTitle(R.string.about_dialog_title).setMessage(R.string.about_dialog_message).setNeutralButton("Dismiss", null).show();
...
//        selectImage();
        Log.v("CameraKitView", "onPermissionsGranted");
        cameraView.onStart();
    }
