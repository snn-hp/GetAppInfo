...
import com.yumu.appinfo.layoutmanager.ScaleCardLayoutManager;
 ...
 * 最美 画廊效果
 */
public class ZuiMeiCardActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        recyclerView.setLayoutManager(new ScaleCardLayoutManager());
