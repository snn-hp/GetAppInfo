...
public class NumberAnimTextView extends TextView {
     ...
     * 前缀
     */
    private String mPrefixString = "实时在线";
    /**
     * 后缀
     */
    private String mPostfixString = "人";
    /**
     * 是否开启动画
     */
    ...
    public void setNumberString(String number) {
        setNumberString(mNumStart, number);
    }
...
//            setText(mPrefixString + getNumberSpan(numberEnd) + mPostfixString);
            setStyle(numberEnd);
        }
    }
...
//            setText(mPrefixString + format(new BigDecimal(mNumEnd)) + mPostfixString);
            setStyle(format(new BigDecimal(mNumEnd)));
            return;
        }
...
//                setText(mPrefixString + mNumEnd+ mPostfixString);
    ...
    public void setStyle(String mNumEnd) {
        Spanned spanned = Html.fromHtml(mPrefixString + " <myfont size='25px'  color=\"#EB388C\">" + mNumEnd + "</myfont> " + "<myfont  size='17px' color=\"#333333\">" + mPostfixString + "</myfont> ", null, new MyHtmlTagHandler("myfont"));
        setText(spanned);
    }
