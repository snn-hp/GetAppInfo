...
public interface OnSwipeListener<T> {
     ...
     */
    default void onSwiping(RecyclerView.ViewHolder viewHolder, float ratio, int direction) {
    }
     ...
     */
    default void onSwiped(RecyclerView.ViewHolder viewHolder, T t, int direction) {
    }

    /**
     * 所有的卡片全部滑出时回调
     */
    default void onSwipedClear() {
    }

    default void getNextPage() {
    }
