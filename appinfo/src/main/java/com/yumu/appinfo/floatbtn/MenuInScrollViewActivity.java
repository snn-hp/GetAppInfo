...
public class MenuInScrollViewActivity extends AppCompatActivity implements FloatingActionMenu.MenuStateChangeListener, ViewTreeObserver.OnScrollChangedListener, View.OnLayoutChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rlIcon1.setImageDrawable(getResources().getDrawable(R.mipmap.ic_action_place_light));
        rlIcon2.setImageDrawable(getResources().getDrawable(R.mipmap.ic_action_picture_light));
        rlIcon3.setImageDrawable(getResources().getDrawable(R.mipmap.ic_action_camera_light));
